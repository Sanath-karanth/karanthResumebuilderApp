  ...
  return [
    {
      ...
      fplatnameval,
      setFplatnameVal,
      fcertificatemonthval,
      setFcertificatemonthVal,
      fcertificateyearval,
      setFcertificateyearVal,
      roleOptionsFresher,
    },
  ];
}
