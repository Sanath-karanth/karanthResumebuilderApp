                ...
                <div className="social-icons-container">
                    <div className='socialIcon-cont'>
                        <a href="http://www.gmail.com" target="_blank" rel="noopener noreferrer">
                            <i className="fa fa-envelope socialicon" style={{color:theme.footerSocialIconcolor}}></i>
                        </a>
                    </div>
                    <div className='socialIcon-cont'>
                        <a href="https://www.facebook.com/sanaths.karanth/" target="_blank" rel="noopener noreferrer">
                            <i className="fa fa-facebook socialicon" style={{color:theme.footerSocialIconcolor}}></i>
                        </a>
                    </div>
                    <div className='socialIcon-cont'>
                        <a href="https://www.linkedin.com/in/sanath-s-karanth-758bbb176" target="_blank" rel="noopener noreferrer">
                            <i className="fa fa-linkedin-square socialicon" style={{color:theme.footerSocialIconcolor}}></i>
                        </a>
                    </div>
